...
Sessions allow the user to stay logged in, even when you reload a page.

1. What does bcrypt do to help us store passwords in a secure manner.

bcrpyt incorporates a salt to protect against rainbow table attacks, an encryption key is derived from the salt & cost-factor

1. What does bcrypt do to slow down attackers?

- hashes the password to slow down attackers
